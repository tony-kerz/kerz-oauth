...
public abstract class TestTokenStoreBase
{
  ...
  {
    OAuth2Authentication expectedAuthentication = new OAuth2Authentication(new AuthorizationRequest("id", null, null, null),
  ...
  public void testGetAccessTokenForDeletedUser() throws Exception
  {
    ...
    assertEquals(expectedAuthentication, getTokenStore().readAuthentication(expectedOAuth2AccessToken));
    OAuth2Authentication anotherAuthentication = new OAuth2Authentication(new AuthorizationRequest("id", null, null, null),
  ...
  protected static class TestAuthentication extends UsernamePasswordAuthenticationToken
  {
    public TestAuthentication(String name, boolean authenticated)
    {
      super(new User(name, "", getDummyAuthorities()), null, getDummyAuthorities());
    }
    
    private static Collection<GrantedAuthority> getDummyAuthorities()
    {
